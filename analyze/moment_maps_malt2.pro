pro moment_maps_malt2,directory
base_mom_maps = '/mako4/b/malt90/malt90-survey-data/moment_maps/'
in_dir = '/mako4/b/malt90/malt90-survey-data/'
...
;                print,size(spec)
                ...
                ;s = replicate(1,3,3,3)
				;print,size(mask)
                ;masktemp = dilate(erode(mask,s),s)
                ;disp,mask
                ;window,2
                ;disp,masktemp
                ;stop
